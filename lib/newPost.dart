  ...
  Widget build(BuildContext context) {
    ...
    return new Scaffold(
      ...
      body: new ListView(
        children: [
          new Padding(
              padding: EdgeInsets.only(top: h * 0.03, right: 20, left: 20)),
          new Text(
            'Title',
            style: TextStyle(
                fontSize: w * 0.07,
          ...
          new Padding(
              padding: EdgeInsets.only(top: h * 0.01, right: 20, left: 20)),
          new TextField(
            ...
            children: [
              new Padding(
                  padding: EdgeInsets.only(
                      top: h * 0.1, right: w * 0.2, left: w * 0.2)),
              new RaisedButton(
                ...
                onPressed: () {
                  if (_titleController.text.trim().isEmpty ||
                    ...
                    setState(() {
                      databaseHelper.newPostData(_titleController.text.trim(),
